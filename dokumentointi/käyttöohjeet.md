...
Keskusteluntutkijat (esim. http://www.intersubjectivity.fi/) tekevät annotaatioita keskusteluista tehtyihin nauhotteisiin. Annotaatiot koskevat jotakin aikaväliä jollakin tietyllä nauhoitteella. Annotaatioitten tekoon käytettyistä ohjelmista esimerkki on Elan (https://tla.mpi.nl/tools/tla-tools/elan/). Annotaatioita voi Elanista viedä tekstitiedostoihin.
